...
```dart
    Widget build(BuildContext context) {
        return Scaffold(
            body: SafeArea(
                ...
                child: Column(
                    children: [
                        AdController(key: _adControllerKey, game: game), // Ad Widget
                        Expanded(
                            child: Center(
                                child: FittedBox(
                                    child: SizedBox(
                                        width: gameWidth,
                                        height: gameHeight,
                                        child: GameWidget(game: game), // Game Widget
                                    ),
                                ),
                            ),
                        ),
    ...
    Caution is needed when using code.
